...
program define primus_message
	...
	if `error'==802 noi dis "{err}Operation failed: User lacks Approver/Uploader role for specified country"
	...
	if `error'==813 noi dis "{err}The provided transaction id is incorrect"	
	...
	if `error'==831 noi dis "{err}ProcessId is not valid with the TransactionId"	
