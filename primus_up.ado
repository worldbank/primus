...
//Price database!
    qui datalibweb, country(Support) year(2005) type(GMDRAW) surveyid(Support_2005_CPI_v08_M) filename(Final_CPI_PPP_to_be_used.dta) clear
    di r(cmdline)
...
cap datalibweb, country(support) year(2005) type(gmdraw) filename(Survey_price_framework.dta) surveyid(Support_2005_CPI_v08_M)
if _rc!=0{
